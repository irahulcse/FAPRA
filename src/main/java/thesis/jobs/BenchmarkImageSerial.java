...
import thesis.common.sources.CameraSourceUpgrade;
...
import thesis.flink.sink.ImageSink;
 ...
 *
 */
public class BenchmarkImageSerial {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<ImageData> imageStream = env.addSource(new CameraSourceUpgrade(10,1000));
