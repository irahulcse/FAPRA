...
public class Selector<T extends Data<?>> extends CoProcessFunction<Tuple2<String, VehicleContext>, SwitchingDecision, T> {
    ...
    @Override
    public void processElement1(Tuple2<String, VehicleContext> value, CoProcessFunction<Tuple2<String, VehicleContext>, SwitchingDecision, T>.Context ctx, Collector<T> out) throws Exception {
